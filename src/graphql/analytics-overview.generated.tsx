...
export type EngagementFragment = { __typename?: 'Engagement', createdat: any, type: string, count: number, cost: number, android: number, ios: number, linux: number, macos: number, windows: number };
