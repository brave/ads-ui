 ...
 * });
 */
export function useLoadCampaignQuery(baseOptions: Apollo.QueryHookOptions<LoadCampaignQuery, LoadCampaignQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LoadCampaignQuery, LoadCampaignQueryVariables>(LoadCampaignDocument, options);
      }
export function useLoadCampaignLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LoadCampaignQuery, LoadCampaignQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LoadCampaignQuery, LoadCampaignQueryVariables>(LoadCampaignDocument, options);
        }
export type LoadCampaignQueryHookResult = ReturnType<typeof useLoadCampaignQuery>;
export type LoadCampaignLazyQueryHookResult = ReturnType<typeof useLoadCampaignLazyQuery>;
export type LoadCampaignQueryResult = Apollo.QueryResult<LoadCampaignQuery, LoadCampaignQueryVariables>;
export function refetchLoadCampaignQuery(variables: LoadCampaignQueryVariables) {
