        ...
        return (
            <div>
                <>
                    ...
                    <Text content={"Mac OS"} style={{ marginBottom: "-8px" }} sizes={[16, 16, 15, 15, 13]} fontFamily={"Poppins"} />
                    <div style={{ backgroundColor: "white", borderRadius: "4px", width: "100%", height: "133px", marginBottom: "16px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        ...
                        <div style={{ height: "106px", width: "359px", borderRadius: "13px", border: "1px solid #e2e2e2", backgroundColor: "rgba(248, 248, 248, 0.82)", padding: "8px" }}>
                            ...
                            <div style={{ marginTop: "8px", overflowWrap: "break-word" }}>
                                <Text style={{ width: "250px", paddingLeft: "5px" }} content={this.props.body} sizes={[16, 16, 15, 15, 12]} fontFamily={"Muli"} />
                            </div>
                        </div>
                    </div>

                    <Text content={"iOS"} style={{ marginBottom: "-38px" }} sizes={[16, 16, 15, 15, 13]} fontFamily={"Poppins"} />
                    <div style={{ backgroundColor: "white", borderRadius: "4px", width: "100%", height: "133px", marginTop: "16px", marginBottom: "16px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <div style={{ height: "82px", width: "326px", borderRadius: "13px", border: "1px solid #e2e2e2", backgroundColor: "rgb(250, 250, 250)", padding: "8px" }}>
                            ...
                            <div style={{ marginTop: "-20px", paddingLeft: "49px", overflowWrap: "break-word" }}>
                                <Text style={{ width: "250px" }} content={this.props.body} sizes={[16, 16, 15, 15, 12]} fontFamily={"Muli"} />
                            </div>
                        </div>
                    </div>

                    <Text content={"Windows"} style={{ marginBottom: "-12px" }} sizes={[16, 16, 15, 15, 13]} fontFamily={"Poppins"} />
                    <div style={{ backgroundColor: "white", borderRadius: "4px", width: "100%", height: "133px", marginTop: "16px", marginBottom: "16px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <div style={{ height: "126px", width: "300px", backgroundColor: "rgb(61, 61, 61)", padding: "8px" }}>
                            <div style={{ display: "flex", width: "100%" }}>
                                <img src={BraveLogo} style={{ height: "44px", width: "44px", marginTop: "5px" }} />
                                <div style={{ marginTop: '12px' }}>
                                    <div style={{ overflowWrap: "break-word" }}>
                                        <Text style={{ width: "230px", paddingLeft: "5px" }} color={"white"} fontWeight={600} content={this.props.title} sizes={[16, 16, 15, 15, 12]} fontFamily={"Muli"} />
                                    </div>
                                    <div style={{ marginTop: "8px", overflowWrap: "break-word" }}>
                                        <Text style={{ width: "230px", paddingLeft: "5px" }} color={"white"} content={this.props.body} sizes={[16, 16, 15, 15, 12]} fontFamily={"Muli"} />
                                    </div>
                                </div>
                            </div>
                            <div style={{ backgroundColor: "rgb(101, 101, 101)", width: "88px", height: "28px", marginLeft: "auto", marginTop: "12px", marginRight: "8px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                    ...
                    <div style={{ backgroundColor: "white", borderRadius: "4px", width: "100%", height: "120px", marginTop: "16px", marginBottom: "16px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <div style={{ height: "72px", width: "340px", borderRadius: "13px", border: "1px solid #e2e2e2", backgroundColor: "rgb(250, 250, 250)", padding: "8px" }}>
                            <div style={{ display: "flex", width: "100%" }}>
                                <img src={BraveLogo} style={{ height: "44px", width: "44px", marginTop: "5px" }} />
                                <div style={{ marginTop: "2px", overflowWrap: "break-word", marginRight: "8px" }}>
                                    <Text style={{ width: "230px", paddingLeft: "5px" }} fontWeight={600} content={this.props.title} sizes={[16, 16, 15, 15, 12]} fontFamily={"Muli"} />
                                    <Text content={this.props.body} style={{ width: "230px", paddingLeft: '5px', marginTop: "8px" }} sizes={[16, 16, 15, 15, 12]} fontFamily={"Muli"} />
                                </div>
